        ...
        <section id="limitations">
          ...
          <div className="space-y-4 mt-6">
            {[
              ...
              { icon: '🔗', title: 'Post-Payment Third-Party Integration', desc: 'Any business logic or provisioning that happens after payment (e.g. creating trading accounts, sending access credentials) is outside the scope of this plugin. These are handled by other Yourpropfirm plugins (Finpr, QTG) or third-party integrations.' },
